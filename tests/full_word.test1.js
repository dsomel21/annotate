    ...
    describe('This should grab FULL_WORDS and test', () => {
      ...
      beforeAll(async () => {
        ...
        await actions
          ...
          .perform();
        await actions
          .move({ x: parseInt(x + 200), y: parseInt(y) })
          .pause(500)
          .release()
          .perform();
        // await actions.pause(500).release().perform();

        data_grabbing_extra_space = await driver.executeScript(
    ...
    describe('This should grab FULL_WORDS and test', () => {
      ...
      beforeAll(async () => {
        ...
        await actions
          ...
          .perform();
        await actions
          .move({ x: parseInt(x + 100), y: parseInt(y) })
          .pause(500)
          .release()
          .perform();

        data_grabbing_extra_comma = await driver.executeScript(
          'return window.getSelection().toString();'
        );
