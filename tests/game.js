...
describe('This should run basic tests on game.', () => {
    ...
    describe('it captures a screenshot of the current page on the browser', () => {
      ...
      it('Should successfully login', async () => {driver.executeScript('return document.readyState');
        ...
        await driver.executeScript("arguments[0].setAttribute('value', '" + test_password +"')", password_input);
    ...
    it('Should check for navigations', async () => {
        ...
        const gameNavs = ['Maths', 'English', 'Verbal Reasoning', 'Non Verbal Reasoning', 'Study Time']
        const resultTexts = []
